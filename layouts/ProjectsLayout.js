                  ...
                  <article>
                    <div>
                      <Image
                        ...
                        height={230}
                      />
                      <h2 className="py-1 text-2xl font-bold leading-8 tracking-tight ">{title}</h2>
                      <div className="prose prose-base max-w-none py-2 text-gray-500 dark:text-gray-400 sm:prose-lg">
                        {summary}
                      </div>
